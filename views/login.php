...
<head>
    ...
    <link href="http://localhost/BT3-WEB/public/vendor/animate.css/animate.min.css" rel="stylesheet">
    <link href="http://localhost/BT3-WEB/public/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="http://localhost/BT3-WEB/public/css/login.css">
            ...
            <div class="row justify-content-center animate__animated animate__fadeInUp">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        ...
                        <form method="post" action="/BT3-WEB/login" class="signin-form">
                            <div class="form-group">
                                <input name="username" type="text" class="form-control" placeholder="Tên đăng nhập" required>

                            </div>
                            <div class="form-group">
                                <input name="password" id="password-field" type="password" class="form-control" placeholder="Mật khẩu" required>

                            </div>
                            <div class="form-group">
                                <p><?php check_message() ?></p>
                                <button name="dangnhap" type="submit" class="form-control btn kanit-medium">Đăng
                                    Nhập</button>
                            </div>
                            <div class="form-group ">
                                <div class="inner-pass">
                                    <a href="change" style="color:#ffffff;text-decoration:none;float:left">Đổi mật
                                        khẩu</a>
